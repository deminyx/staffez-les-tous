    ...
    <div>
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-400">Merch associatif — tarif adherent</p>
        </div>
        <Link
          ...
          {products.map((product) => {
            ...
            return (
              <Link
                ...
                className="group relative overflow-hidden rounded-xl border border-white/10 bg-surface-dark transition-all hover:border-brand-red/40"
              >
                {/* Image placeholder */}
                <div className="relative aspect-square bg-white/5">
                  {product.image ? (
                    ...
                    <div className="flex h-full items-center justify-center">
                      <span className="font-display text-4xl text-white/20">S</span>
                    </div>
                  )}
                  {isOutOfStock && (
