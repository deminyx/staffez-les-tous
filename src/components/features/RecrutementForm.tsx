...
import { submitRecrutement } from "@/app/(public)/actions";
...
export function RecrutementForm() {
  const [state, formAction] = useFormState(submitRecrutement, initialState);
  ...
  if (state.success) {
    return (
      <div className="rounded-xl border border-green-200 bg-green-50 p-8 text-center">
        ...
        <h3 className="text-lg font-bold text-green-800">Candidature envoyee !</h3>
        <p className="mt-2 text-sm text-green-700">
          Merci pour votre interet. Un membre de l&apos;equipe vous contactera prochainement.
        </p>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div>
        <label htmlFor="events" className="mb-1 block text-sm font-medium text-gray-700">
      ...
      <p className="text-xs text-gray-500">
        * Champs obligatoires. Vos donnees sont utilisees uniquement dans le cadre du recrutement et
        ne sont pas transmises a des tiers.
      </p>
